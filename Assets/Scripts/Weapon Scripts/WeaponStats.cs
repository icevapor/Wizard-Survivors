...
{
    public static float bubbleDamage = 5.0f;
    ...
    public static float unstablePotionEffectDuration = 7.0f;
    public static float unstablePotionBonusDamage = 2.5f;
    public static float unstablePotionBossDamage = 5.0f;
